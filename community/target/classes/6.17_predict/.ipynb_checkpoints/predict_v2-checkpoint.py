...
def predict(which_model,datapath = 'stock_data/0066.HK.csv',startdate = "2022-01-01",enddate = "2024-3-30"):
    ...
    if which_model == 'lstm':
        ...
        model = torch.load('C:\\Users\\patty.hao\\Downloads\\community1\\community\\target\\classes\\6.17_predict\\pthfile\\lstm_model_complete.pth')
        #model = torch.load('pthfile/lstm_model_complete.pth')
        # 'pthfil/randomforest_model.pth'
        ...
        model = joblib.load('pthfil/linear_regression_model.joblib')
    ...
    if which_model == 'randomforest':
        ...
        model = torch.load('pthfil/randomforest_model.pth')
        ...
        model = torch.load('pthfil/svm_model.pth')
        ...
        # 加载预训练的GRU模型
        loaded_model = torch.jit.load('pthfil/gru_model_script.pth')
